...
const potatoMineAnimation = {
  desactivate: {
    sprites: importSpriteSheet(
      '/sprites/plants/day/potato-mine/desactivate.png',
      new Vector2(16),
      2
    ),
    fps: 1,
  ...
  leave: {
    sprites: importSpriteSheet(
      '/sprites/plants/day/potato-mine/leave.png',
      new Vector2(16),
      5
    ),
    fps: 5,
  ...
  activate: {
    sprites: importSpriteSheet(
      '/sprites/plants/day/potato-mine/activate.png',
      new Vector2(16),
      2
    ),
    fps: 1,
...
export default class PotatoMine extends Plant {
  ...
  constructor(pos: Vector2, zIndex?: number) {
    super(pos, PLANTS.POTATO_MINE, zIndex)
...
class Kapown extends AnimationObject {
  constructor(pos: Vector2) {
    super(
      pos,
      importSpriteSheet(
        '/sprites/plants/day/potato-mine/spudow.png',
        new Vector2(16),
        10
      ),
      10,
