...
const [idle1, idle2, idle3] = importSpriteSheet(
  '/sprites/plants/day/chomper/idle.png',
  new Vector2(16),
  3
)
const [idleEat1, idleEat2, idleEat3] = importSpriteSheet(
  '/sprites/plants/day/chomper/idle-eat.png',
  new Vector2(16),
  3
)
...
const chomperAnimation = {
  ...
  'prepare-to-eat': {
    sprites: importSpriteSheet(
      '/sprites/plants/day/chomper/prepare-to-eat.png',
      new Vector2(32, 16),
      9
    ),
    fps: 5,
  ...
  'init-eat': {
    sprites: importSpriteSheet(
      '/sprites/plants/day/chomper/init-eat.png',
      new Vector2(32, 16),
      9
    ),
    fps: 5,
  ...
  recharge: {
    sprites: importSpriteSheet(
      '/sprites/plants/day/chomper/recharge.png',
      new Vector2(16),
      8
    ),
    fps: 4,
...
export default class Chomper extends Plant {
  ...
  constructor(pos: Vector2, zIndex?: number) {
    super(pos, PLANTS.CHOMPER, zIndex)
