...
const wallNutAnimation = {
  '1': {
    sprites: [
      ...Array(9).fill(
        new SpriteTexture('/sprites/plants/day/wall-nut/1-idle1.png')
      ),
      new SpriteTexture('/sprites/plants/day/wall-nut/1-idle2.png'),
    ],
    fps: 5,
  },
  '2': {
    sprites: [
      ...Array(9).fill(
        new SpriteTexture('/sprites/plants/day/wall-nut/2-idle1.png')
      ),
      new SpriteTexture('/sprites/plants/day/wall-nut/2-idle2.png'),
    ],
    fps: 5,
  },
  '3': {
    sprites: [
      ...Array(9).fill(
        new SpriteTexture('/sprites/plants/day/wall-nut/3-idle1.png')
      ),
      new SpriteTexture('/sprites/plants/day/wall-nut/3-idle2.png'),
    ],
    fps: 5,
  },
}
...
export default class WallNut extends Plant {
  ...
  constructor(pos: Vector2, zIndex?: number) {
    super(pos, PLANTS.WALL_NUT, zIndex)
  }
